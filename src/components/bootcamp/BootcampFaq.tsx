...
const groups = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Are the live sessions required?', a: 'No. All five sessions \u2014 the opening, midpoint, and closing sessions and the two spotlight sessions \u2014 are optional and recorded for on-demand viewing. Days and times are set with the cohort by poll after registration, so we can hopefully find times that work for most people.' },
